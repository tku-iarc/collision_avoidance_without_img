...
from test_obstacle_sac2 import SAC
from test_obstacle_env2 import Test
    ...
    for cnt in range(1000):
        ...
        for __ in range(1000):
            ...
            if done_cnt > 0:    
                ...
                #     with open("test_L.txt","a") as f:
                #         f.write('finishsssssssssssssssssssssssssssssssssssssssssssssssssssssssss')
                #         f.write('\n')
                # if nameIndx == 1:
                ...
                #     with open("test_L0.txt","a") as f:
                #         f.write('finishsssssssssssssssssssssssssssssssssssssssssssssssssssssssss')
                #         f.write('\n')
                # if nameIndx == 1:
                    
                #     with open("test_R0.txt","a") as f:
                #         f.write('finishsssssssssssssssssssssssssssssssssssssssssssssssssssssssss')  
                #         f.write('\n')
