...
class SAC(object):
    def __init__(self, act_dim, obs_dim, name=None):
        ...
        if self.name == 'right_':
            self.path = '/home/yue/no_image/collision_surroding/src/collision_surouding/Collision_Avoidance/train/weights/'+ NAME +'/'+ self.name+'40'
        else:
            self.path = '/home/yue/no_image/collision_surroding/src/collision_surouding/Collision_Avoidance/train/weights/'+ NAME +'/'+ self.name+'50'
        # self.path = '/home/yue/yuetin/collision_surrouding/src/Collision_Avoidance/train/weights/'+ NAME +'/'+ self.name+'50'
